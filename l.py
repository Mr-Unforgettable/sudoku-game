...
canvas.pack()
photo = PhotoImage(file='C:\\Users\\Abhinav\\Downloads\\sudoku-instructions.png')
canvas.create_image(0 , 0 , image=photo , anchor=NW )
btn = Button(root, text = 'START' , width = 1680 , height = 15 , fg = "black" , bg = "pink" , command = root.destroy)
...
class SudokuGUI(Frame):
    board_generators = {"# HARD":sudogen_1}
    ...
    def query_board(self):
        window = self.make_modal_window("MODE")
    ...
    def __init__(self, master, board):
        ...
        self.query = Button(bframe, command=self.query_board, text="Mode")
